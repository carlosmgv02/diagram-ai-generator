...
generate-example: ## Genera un diagrama de ejemplo
	...
	python diagram_ai.py generate "aplicación web con load balancer, servidores web y base de datos" --title "Ejemplo de Arquitectura"

list-providers: ## Lista proveedores disponibles
	@echo "📋 Listando proveedores..."
	python diagram_ai.py list-providers

search-aws: ## Busca componentes de AWS
	@echo "🔍 Buscando componentes de AWS..."
	python diagram_ai.py search "ec2" --provider aws

test-connection: ## Prueba conexión con OpenAI
	@echo "🔌 Probando conexión..."
	python diagram_ai.py test-connection
